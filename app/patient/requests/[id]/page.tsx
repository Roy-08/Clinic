...
export default async function PatientRequestDetail({
  params,
}: {
  ...
  if (!r || !user || r.patientId !== user.id) notFound();
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-0.5 text-xs text-slate-500">
              Paid ₹{r.price} · {new Date(r.createdAt).toLocaleString()}
            </div>
          </div>
